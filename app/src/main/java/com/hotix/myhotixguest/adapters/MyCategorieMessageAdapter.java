...
public class MyCategorieMessageAdapter extends BaseAdapter {

    Context context;
    ArrayList<MessageCategorie> mData;
    LayoutInflater inflter;

    public MyCategorieMessageAdapter(Context applicationContext, ArrayList<MessageCategorie> mData) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        names.setText(mData.get(i).getCategorieName());
        if (mData.get(i).getCategorieID() == -1) {
